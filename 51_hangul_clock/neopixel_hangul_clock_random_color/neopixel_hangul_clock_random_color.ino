...
//uint32_t strip.Color(random(255), random(255), random(255)) = strip.Color(255, 0, 0);
//uint32_t strip.Color(random(255), random(255), random(255)) = strip.Color(255, 255, 0);
//uint32_t strip.Color(random(255), random(255), random(255)) = strip.Color(0, 255, 0);
//uint32_t strip.Color(random(255), random(255), random(255)) = strip.Color(0, 0, 255);
//uint32_t strip.Color(random(255), random(255), random(255)) = strip.Color(255, 0, 255);
...
void hoursFilter(int hours,int minutes){
  if(hours == 0 && minutes < 5){  //00:00
    strip.setPixelColor(15,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(16,strip.Color(random(255), random(255), random(255)));}
  else if(hours == 12 && minutes < 5){
    strip.setPixelColor(16,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(21,strip.Color(random(255), random(255), random(255)));}
  else if(hours == 1 || hours == 13){
    strip.setPixelColor(1,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(14,strip.Color(random(255), random(255), random(255)));}
  else if(hours == 2 || hours == 14){
    strip.setPixelColor(5,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(14,strip.Color(random(255), random(255), random(255)));}
  else if(hours == 3 || hours == 15){
    strip.setPixelColor(3,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(14,strip.Color(random(255), random(255), random(255)));}
  else if(hours == 4 || hours == 16){
    strip.setPixelColor(4,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(14,strip.Color(random(255), random(255), random(255)));}    
  else if(hours == 5 || hours == 17){
    strip.setPixelColor(2,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(7,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(14,strip.Color(random(255), random(255), random(255)));}  
  else if(hours == 6 || hours == 18){
    strip.setPixelColor(6,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(7,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(14,strip.Color(random(255), random(255), random(255)));} 
  else if(hours == 7 || hours == 19){
    strip.setPixelColor(8,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(9,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(14,strip.Color(random(255), random(255), random(255)));}   
  else if(hours == 8 || hours == 20){
    strip.setPixelColor(10,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(11,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(14,strip.Color(random(255), random(255), random(255)));}
  else if(hours == 9 || hours == 21){
    strip.setPixelColor(12,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(13,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(14,strip.Color(random(255), random(255), random(255)));}     
...
void minutesFilter(int minutes){
 if(minutes>4 && minutes<10){
    strip.setPixelColor(21,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(24,strip.Color(random(255), random(255), random(255)));}
 else if(minutes>9 && minutes<15){
    strip.setPixelColor(19,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(24,strip.Color(random(255), random(255), random(255)));}
 else if(minutes>14 && minutes<20){
    strip.setPixelColor(22,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(23,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(24,strip.Color(random(255), random(255), random(255)));}
 else if(minutes>19 && minutes<25){
    strip.setPixelColor(17,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(22,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(24,strip.Color(random(255), random(255), random(255)));}
    ...
    strip.setPixelColor(19,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(18,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(24,strip.Color(random(255), random(255), random(255)));}
    ...
    strip.setPixelColor(20,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(22,strip.Color(random(255), random(255), random(255)));
    strip.setPixelColor(24,strip.Color(random(255), random(255), random(255)));}
