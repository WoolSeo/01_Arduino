...
const byte XB_RX = 3; // XBee's RX (Din) pin
const byte XB_TX = 4; // XBee's TX (Dout) pin

SoftwareSerial mySerial(XB_RX, XB_TX); // RX, TX
  ...
  else
  {
    ...
    if (myIMU.delt_t > 500)
    {
      if(SerialDebug)
      {
        ...
        data = String(data + String((int)1000*myIMU.ax) + "\t"+ String((int)1000*myIMU.ay) + "\t"+ String((int)1000*myIMU.az) + "\t");
        data = String(data + String(myIMU.gx) + "\t"+ String(myIMU.gy) + "\t"+ String(myIMU.gz) + "\t");
        data = String(data + String((int)myIMU.mx) + "\t"+ String((int)myIMU.my) + "\t"+ String((int)myIMU.mz) + "\t");
        data = String(data + String(*getQ()) + "\t"+ String(*(getQ() + 1)) + "\t"+ String(*(getQ() + 2)) + "\t" + String(*(getQ() + 3)) + "\t");
      ...
      if(SerialDebug)
      {
        ...
        data = String(data + String(myIMU.yaw) + "\t"+ String(myIMU.pitch) + "\t"+ String(myIMU.roll) + "\t end");
